...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-[#F5F1E8] canvas-texture relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 max-w-2xl mx-auto">
              Follow our development journey on Instagram
            </p>
            <a
              href="https://instagram.com/tagstech"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-4 text-[#A67C52] hover:text-[#2C5F5D] transition-colors font-semibold"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { 
                url: 'https://www.instagram.com/reel/DRddzdJDpvu/',
                embedUrl: 'https://www.instagram.com/reel/DRddzdJDpvu/embed',
                title: 'TAGS Demo'
              },
              { 
                url: 'https://www.instagram.com/reel/DRdqSQMDkH0/',
                embedUrl: 'https://www.instagram.com/reel/DRdqSQMDkH0/embed',
                title: 'Brand Recognition'
              },
              { 
                url: 'https://www.instagram.com/reel/DRLLa0hjl0W/',
                embedUrl: 'https://www.instagram.com/reel/DRLLa0hjl0W/embed',
                title: 'Processing Speed'
              }
            ].map((reel, i) => (
              <div key={i} className="relative group">
                <div className="absolute -inset-2 bg-gradient-to-br from-[#2C5F5D] to-[#A67C52] rounded-2xl opacity-60 blur-sm group-hover:opacity-80 transition-opacity"></div>
                <div className="relative bg-white rounded-xl p-3 shadow-xl distressed-border overflow-hidden">
                  ...
                  <div className="mt-3 text-center">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-[#2C5F5D] hover:text-[#A67C52] transition-colors font-semibold text-sm"
                    >
      ...
      {/* Pitch Deck Section - FIXED CONTRAST */}
      <section id="pitch" className="py-20 bg-[#1a3d3b] text-white canvas-texture relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-6xl font-bold mb-4 letterpress text-white">
              Investor Materials
            </h2>
          ...
          <div className="bg-[#2C5F5D] rounded-2xl p-8 md:p-12 distressed-border relative overflow-hidden shadow-2xl border border-white/10">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#A67C52]/20 rounded-full blur-2xl"></div>
            
            <div className="relative">
              <div className="text-center mb-8">
                <h3 className="text-3xl md:text-4xl font-bold mb-2 letterpress text-white">TAGS Technologies Pitch Deck</h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                {[
                  ...
                  <div key={i} className="text-center p-4 bg-white/10 rounded-lg hover:bg-white/15 transition-colors border border-white/5">
                    <div className="text-3xl md:text-4xl font-bold text-[#D4A574] mb-1">{stat.value}</div>
